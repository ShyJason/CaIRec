...
--first_eval false \
--save_best true \
--config ./config/pmrl/finetune_cfg/retrieval-vggsound.json \
--pretrain_dir ./pretrain_vast \
--output_dir outputs/pretrain_promrl_vggsound \
...
--valid_freq 16 \
--lambda_itm 0.1 \
--log_name pretrain_promrl_vggsound \
...
--config ./config/pmrl/finetune_cfg/retrieval-vggsound.json \
--pretrain_dir ./pretrain_vast \
--output_dir outputs/pretrain_pmrl_vggsound \
--checkpoint ./SVD_MM/PMCL/output/gram/pretrain_pmcl/downstream/pretrain_intra_0.05_inter_0.1_itm_0.1/ckpt/best_ret%tvas--msrvtt_ret_msrvtt_ret_ret_itm_tvas.pt \
--model_type pmrl \
--tau1 0.05 \
--tau2 0.1 \
--valid_freq 16 \
--lambda_itm 0.1 \
--log_name pretrain_pmrl_vggsound \
--feature_inference false
