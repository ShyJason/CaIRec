...
--first_eval false \
--save_best true \
--config ./config/pmrl/finetune_cfg/retrieval-webvid+audiocaps.json \
--pretrain_dir ./pretrain_vast \
--output_dir outputs/pretrain_promrl_webvid+audiocaps \
...
--valid_freq 16 \
--lambda_itm 0.1 \
--log_name pretrain_promrl_webvid+audiocaps \
