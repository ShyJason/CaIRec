...
RUN_TAG="${RUN_TAG:-missing_reliability_gate_$(date +%Y%m%d_%H%M%S)}"
...
# name|floor|gate_reg|target_mean|context|hidden|dropout|init_logit
CANDIDATES=(
  "gate_floor07_reg0_ctxid|0.70|0.0|0.95|id_embedding|64|0.10|1.5"
  "gate_floor07_reg001_ctxid|0.70|0.01|0.95|id_embedding|64|0.10|1.5"
  "gate_floor085_reg001_ctxid|0.85|0.01|0.97|id_embedding|64|0.10|1.5"
  "gate_floor05_reg001_ctxid|0.50|0.01|0.90|id_embedding|64|0.10|1.5"
  "gate_floor07_reg001_ctxshared|0.70|0.01|0.95|shared_mean|64|0.10|1.5"
  "gate_floor07_reg001_ctxoff|0.70|0.01|0.95|off|64|0.10|1.5"
  "gate_floor09_reg001_ctxid|0.90|0.01|0.98|id_embedding|64|0.10|1.5"
  "gate_floor07_reg005_ctxid|0.70|0.05|0.95|id_embedding|64|0.10|1.5"
)
...
launch_candidate() {
  local candidate="$1"
  local gpu="$2"
  IFS="|" read -r name gate_floor gate_reg target_mean context hidden dropout init_logit <<< "${candidate}"
  ...
  if [[ "${context}" == "off" ]]; then
    cmd+=(--completion_gate_use_item_context 0)
  fi
