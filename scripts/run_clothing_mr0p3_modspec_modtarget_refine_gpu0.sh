...
GPU="${GPU:-0}"
RUN_TAG="${RUN_TAG:-modtarget_refine_gpu${GPU}_$(date +%Y%m%d_%H%M%S)}"
OUT_DIR="${OUT_DIR:-exp_report/clothing/modality_dynamic_modspec_modtarget_refine_mr0p3/${RUN_TAG}}"
mkdir -p "${OUT_DIR}"
...
# name|cf|image|text|reg|text_rr|text_ri|text_ii|image_rr|image_ri|image_ii
CANDIDATES=(
  "cf015_t045_i055_reg002|0.15|0.425|0.425|0.02|0.45|0.10|0.02|0.05|0.05|0.55"
  "cf015_t045_i055_reg005|0.15|0.425|0.425|0.05|0.45|0.10|0.02|0.05|0.05|0.55"
  "cf015_t050_i060_reg002|0.15|0.425|0.425|0.02|0.50|0.10|0.02|0.05|0.05|0.60"
  "cf010_t045_i055_reg002|0.10|0.450|0.450|0.02|0.45|0.10|0.02|0.05|0.05|0.55"
)
...
for candidate in "${CANDIDATES[@]}"; do
  IFS="|" read -r name cf_weight image_weight text_weight reg_coeff text_rr text_ri text_ii image_rr image_ri image_ii <<< "${candidate}"
