...
RUN_TAG="${RUN_TAG:-clothing_topk10_local_mr${MR_TAG}_$(date +%Y%m%d_%H%M%S)}"

OUT_DIR="${OUT_DIR:-exp_report/clothing/topk10_local_hparam_search/${RUN_TAG}}"
...
CANDIDATES=(
  # Current best center: mainline topk20 changed to topk10.
  "topk10_center 47 1.0 0.01 0.01 0.25 0.005 0.2 256 0.3 0.35 0.35 10"

  # Fine-grained top-k scan around the current best.
  "topk5 47 1.0 0.01 0.01 0.25 0.005 0.2 256 0.3 0.35 0.35 5"
  "topk8 47 1.0 0.01 0.01 0.25 0.005 0.2 256 0.3 0.35 0.35 8"
  "topk12 47 1.0 0.01 0.01 0.25 0.005 0.2 256 0.3 0.35 0.35 12"
  "topk15 47 1.0 0.01 0.01 0.25 0.005 0.2 256 0.3 0.35 0.35 15"

  # Rec-neighbor CL interactions with topk10.
  "topk10_cltemp0p1 47 1.0 0.01 0.01 0.25 0.005 0.1 256 0.3 0.35 0.35 10"
  "topk10_cltemp0p15 47 1.0 0.01 0.01 0.25 0.005 0.15 256 0.3 0.35 0.35 10"
  "topk10_clw0p003 47 1.0 0.01 0.01 0.25 0.003 0.2 256 0.3 0.35 0.35 10"
  "topk10_clw0p01 47 1.0 0.01 0.01 0.25 0.01 0.2 256 0.3 0.35 0.35 10"

  # Stage2 BPR and regularization interactions with topk10.
  "topk10_mbpr1p5 47 1.5 0.01 0.01 0.25 0.005 0.2 256 0.3 0.35 0.35 10"
  "topk10_mbpr0p5 47 0.5 0.01 0.01 0.25 0.005 0.2 256 0.3 0.35 0.35 10"
  "topk10_reg0p005 47 1.0 0.01 0.005 0.25 0.005 0.2 256 0.3 0.35 0.35 10"
  "topk10_reg0p015 47 1.0 0.01 0.015 0.25 0.005 0.2 256 0.3 0.35 0.35 10"

  # Item-graph residual and graph-source interactions with topk10.
  "topk10_malpha0p1 47 1.0 0.01 0.01 0.1 0.005 0.2 256 0.3 0.35 0.35 10"
  "topk10_malpha0p5 47 1.0 0.01 0.01 0.5 0.005 0.2 256 0.3 0.35 0.35 10"
  "topk10_graph_cf040 47 1.0 0.01 0.01 0.25 0.005 0.2 256 0.4 0.3 0.3 10"
  "topk10_graph_modal040 47 1.0 0.01 0.01 0.25 0.005 0.2 256 0.2 0.4 0.4 10"

  # Check whether the best checkpoint epoch from the wider search transfers to topk10.
  "topk10_e45 45 1.0 0.01 0.01 0.25 0.005 0.2 256 0.3 0.35 0.35 10"
)
