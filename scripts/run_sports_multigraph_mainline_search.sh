...
RUN_TAG="${RUN_TAG:-sports_multigraph_mainline_mr${MR_TAG}_seed${SEED:-1}_$(date +%Y%m%d_%H%M%S)}"

OUT_DIR="${OUT_DIR:-exp_report/sports/multigraph_mainline_search/${RUN_TAG}}"
...
MAINLINE_CANDIDATES=(
  # Verified best from the stopped broad search: Sports data with the Clothing topk10 multigraph prior.
  "center_transfer_topk10 19 256 1.0 0.001 0.0001 0.25 0.005 0.2 256 0.3 0.35 0.35 10"

  # Stage1.2 checkpoint sanity around the best center.
  "center_ckpt18 18 256 1.0 0.001 0.0001 0.25 0.005 0.2 256 0.3 0.35 0.35 10"
  "center_ckpt15 15 256 1.0 0.001 0.0001 0.25 0.005 0.2 256 0.3 0.35 0.35 10"

  # Graph neighborhood: topk and source weights, keeping all graph sources positive.
  "topk5 19 256 1.0 0.001 0.0001 0.25 0.005 0.2 256 0.3 0.35 0.35 5"
  "topk8 19 256 1.0 0.001 0.0001 0.25 0.005 0.2 256 0.3 0.35 0.35 8"
  "topk12 19 256 1.0 0.001 0.0001 0.25 0.005 0.2 256 0.3 0.35 0.35 12"
  "topk15 19 256 1.0 0.001 0.0001 0.25 0.005 0.2 256 0.3 0.35 0.35 15"
  "topk20 19 256 1.0 0.001 0.0001 0.25 0.005 0.2 256 0.3 0.35 0.35 20"
  "graph_modal040_topk10 19 256 1.0 0.001 0.0001 0.25 0.005 0.2 256 0.2 0.4 0.4 10"
  "graph_modal0375_topk10 19 256 1.0 0.001 0.0001 0.25 0.005 0.2 256 0.25 0.375 0.375 10"
  "graph_cf040_topk10 19 256 1.0 0.001 0.0001 0.25 0.005 0.2 256 0.4 0.3 0.3 10"
  "graph_image045_text035_topk10 19 256 1.0 0.001 0.0001 0.25 0.005 0.2 256 0.2 0.45 0.35 10"
  "graph_image035_text045_topk10 19 256 1.0 0.001 0.0001 0.25 0.005 0.2 256 0.2 0.35 0.45 10"

  # Modal residual strength around the current mainline alpha=0.25.
  "malpha0p10 19 256 1.0 0.001 0.0001 0.10 0.005 0.2 256 0.3 0.35 0.35 10"
  "malpha0p20 19 256 1.0 0.001 0.0001 0.20 0.005 0.2 256 0.3 0.35 0.35 10"
  "malpha0p35 19 256 1.0 0.001 0.0001 0.35 0.005 0.2 256 0.3 0.35 0.35 10"
  "malpha0p50 19 256 1.0 0.001 0.0001 0.50 0.005 0.2 256 0.3 0.35 0.35 10"

  # Loss and optimizer neighborhood around the verified center.
  "mbpr0p5 19 256 0.5 0.001 0.0001 0.25 0.005 0.2 256 0.3 0.35 0.35 10"
  "mbpr1p5 19 256 1.5 0.001 0.0001 0.25 0.005 0.2 256 0.3 0.35 0.35 10"
  "mbpr2p0 19 256 2.0 0.001 0.0001 0.25 0.005 0.2 256 0.3 0.35 0.35 10"
  "lr0p0005 19 256 1.0 0.0005 0.0001 0.25 0.005 0.2 256 0.3 0.35 0.35 10"
  "lr0p002 19 256 1.0 0.002 0.0001 0.25 0.005 0.2 256 0.3 0.35 0.35 10"
  "reg5em05 19 256 1.0 0.001 0.00005 0.25 0.005 0.2 256 0.3 0.35 0.35 10"
  "reg3em04 19 256 1.0 0.001 0.0003 0.25 0.005 0.2 256 0.3 0.35 0.35 10"
  "batch128 19 128 1.0 0.001 0.0001 0.25 0.005 0.2 256 0.3 0.35 0.35 10"
  "batch512 19 512 1.0 0.001 0.0001 0.25 0.005 0.2 256 0.3 0.35 0.35 10"

  # Retained post-GCN true-missing InfoNCE objective, searched locally.
  "reccl0 19 256 1.0 0.001 0.0001 0.25 0.0 0.2 256 0.3 0.35 0.35 10"
  "reccl0p003 19 256 1.0 0.001 0.0001 0.25 0.003 0.2 256 0.3 0.35 0.35 10"
  "reccl0p010 19 256 1.0 0.001 0.0001 0.25 0.010 0.2 256 0.3 0.35 0.35 10"
  "reccl_temp0p15 19 256 1.0 0.001 0.0001 0.25 0.005 0.15 256 0.3 0.35 0.35 10"
  "reccl_temp0p25 19 256 1.0 0.001 0.0001 0.25 0.005 0.25 256 0.3 0.35 0.35 10"
  "reccl_bank128 19 256 1.0 0.001 0.0001 0.25 0.005 0.2 128 0.3 0.35 0.35 10"
  "reccl_bank512 19 256 1.0 0.001 0.0001 0.25 0.005 0.2 512 0.3 0.35 0.35 10"

  # Compact interaction checks around the strongest graph settings.
  "topk8_modal040 19 256 1.0 0.001 0.0001 0.25 0.005 0.2 256 0.2 0.4 0.4 8"
  "topk12_modal040 19 256 1.0 0.001 0.0001 0.25 0.005 0.2 256 0.2 0.4 0.4 12"
  "modal040_malpha0p20 19 256 1.0 0.001 0.0001 0.20 0.005 0.2 256 0.2 0.4 0.4 10"
  "modal040_malpha0p35 19 256 1.0 0.001 0.0001 0.35 0.005 0.2 256 0.2 0.4 0.4 10"
)

SINGLE_GRAPH_ABLATIONS=(
  "single_cf_topk10 19 256 1.0 0.001 0.0001 0.25 0.005 0.2 256 1.0 0.0 0.0 10"
  "single_image_topk10 19 256 1.0 0.001 0.0001 0.25 0.005 0.2 256 0.0 1.0 0.0 10"
  "single_text_topk10 19 256 1.0 0.001 0.0001 0.25 0.005 0.2 256 0.0 0.0 1.0 10"
)
