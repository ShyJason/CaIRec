...
RUN_TAG="${RUN_TAG:-missing_reliability_gate_weightedfusion_$(date +%Y%m%d_%H%M%S)}"
...
CANDIDATES=(
  "wf_floor07_reg05_t090_lrm2_ctxid|0.70|0.50|0.90|id_embedding|64|0.10|0.0|0.0002|1"
  "wf_floor07_reg05_t090_lrm5_ctxid|0.70|0.50|0.90|id_embedding|64|0.10|0.0|0.0005|1"
  "wf_floor07_reg10_t090_lrm5_ctxid|0.70|1.00|0.90|id_embedding|64|0.10|0.0|0.0005|1"
  "wf_floor05_reg10_t085_lrm5_ctxid|0.50|1.00|0.85|id_embedding|64|0.10|0.0|0.0005|1"
  "wf_floor05_reg05_t085_lrm5_ctxid|0.50|0.50|0.85|id_embedding|64|0.10|0.0|0.0005|1"
  "wf_floor07_reg05_t095_lrm5_ctxid|0.70|0.50|0.95|id_embedding|64|0.10|0.0|0.0005|1"
  "wf_floor07_reg05_t090_lrm5_ctxshared|0.70|0.50|0.90|shared_mean|64|0.10|0.0|0.0005|1"
  "wf_floor07_reg01_t090_lrm5_ctxid|0.70|0.10|0.90|id_embedding|64|0.10|0.0|0.0005|1"
)
...
launch_candidate() {
  ...
  local cmd=(
    ...
    --fusion_mode reliability_weighted_mean
    --tensorboard 0
    --save 1
    --topk "[10, 20, 30, 40, 50]"
    --suffix "${suffix}"
