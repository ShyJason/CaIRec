...
RUN_TAG="${RUN_TAG:-missing_reliability_gate_refine_$(date +%Y%m%d_%H%M%S)}"
...
# name|floor|gate_reg|target_mean|context|hidden|dropout|init_logit|gate_lr|stats_norm
CANDIDATES=(
  "norm_floor07_reg001_init0_lr001_ctxid|0.70|0.01|0.95|id_embedding|64|0.10|0.0|0.001|1"
  "norm_floor07_reg001_init0_lrm5_ctxid|0.70|0.01|0.95|id_embedding|64|0.10|0.0|0.0005|1"
  "norm_floor05_reg001_init0_lr001_ctxid|0.50|0.01|0.90|id_embedding|64|0.10|0.0|0.001|1"
  "norm_floor07_reg0_init0_lr001_ctxid|0.70|0.0|0.95|id_embedding|64|0.10|0.0|0.001|1"
  "norm_floor07_reg001_initm1_lr001_ctxid|0.70|0.01|0.90|id_embedding|64|0.10|-1.0|0.001|1"
  "norm_floor07_reg001_init0_lr002_ctxid|0.70|0.01|0.95|id_embedding|64|0.10|0.0|0.002|1"
  "norm_floor085_reg001_init0_lr001_ctxid|0.85|0.01|0.97|id_embedding|64|0.10|0.0|0.001|1"
  "norm_floor07_reg001_init0_lr001_ctxshared|0.70|0.01|0.95|shared_mean|64|0.10|0.0|0.001|1"
)
...
launch_candidate() {
  local candidate="$1"
  local gpu="$2"
  IFS="|" read -r name gate_floor gate_reg target_mean context hidden dropout init_logit gate_lr stats_norm <<< "${candidate}"
...
for candidate in "${CANDIDATES[@]}"; do
  gpu_index=$(( (slot / TASKS_PER_GPU) % ${#gpu_list[@]} ))
