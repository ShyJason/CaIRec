...
CONFIG="configs/beauty/stage2_decoder_mm.yaml"
...
verify_sha256 a6a8319679382f56ffde5b2ab9d7518e5c12e8f6a8928288c3dbe4aabd8696f5 "${CONFIG}"
...
env \
  CONFIG="${CONFIG}" DATASET=beauty EXP_MODE=mm DEVICE_ID=0 \
  SEED=2023 DATASET_SEED=2023 \
  EPOCHS=400 EVA_INTERVAL=1 EARLY_STOP=20 BATCH_SIZE=2048 \
  ...
  ./run_demo_itm.sh \
    ...
    --rec_neighbor_cl_weight 0.010 --rec_neighbor_cl_temp 0.2 \
